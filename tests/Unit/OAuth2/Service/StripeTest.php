...
class StripeTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetAuthorizationEndpoint()
    {
        ...
        $this->assertSame('https://connect.stripe.com/oauth/authorize', (string) $service->getAuthorizationEndpoint());
    }
    ...
    public function testGetAccessTokenEndpoint()
    {
        ...
        $this->assertSame('https://connect.stripe.com/oauth/token', (string) $service->getAccessTokenEndpoint());
    }
    ...
    {
        /** @var Stripe|\PHPUnit_Framework_MockObject_MockObject $service */
        $service = $this->getMock(
            '\\OAuth\\OAuth2\\Service\\Stripe',
            ['httpRequest'],
            [
                $this->getMock('\\OAuth\\Common\\Consumer\\CredentialsInterface'),
                $this->getMock('\\Buzz\\Browser'),
