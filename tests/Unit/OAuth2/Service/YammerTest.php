...
class YammerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testParseAccessTokenResponseValidWithoutRefreshToken()
    {
        ...
        $service->expects($this->once())->method('httpRequest')->will(
            $this->returnValue('{"access_token":{"token":"foo", "expires_at":null}}')
        );
    ...
    public function testParseAccessTokenResponseValidWithRefreshToken()
    {
        ...
        $service->expects($this->once())->method('httpRequest')->will(
            $this->returnValue('{"access_token":{"token":"foo", "expires_at":null},"refresh_token":"baz"}')
        );
