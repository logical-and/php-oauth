...
class AbstractServiceTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetAuthorizationUriWithoutParameters()
    {
        ...
        $this->assertSame(
            'http://pieterhordijk.com/auth?oauth_token=',
    ...
    public function testGetAuthorizationUriWithParameters()
    {
        ...
        $this->assertSame(
            'http://pieterhordijk.com/auth?foo=bar&baz=beer&oauth_token=',
            (string) $service->getAuthorizationUri(
                [
                    'foo' => 'bar',
                    'baz' => 'beer',
    ...
    public function testRequest()
    {
        ...
        $this->assertSame(
            'response!',
            $service->request('/my/awesome/path', ['root' => 'response!'])[ 'body' ][ 'root' ]
        );
    }
}
